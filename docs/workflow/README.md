...
The current authoring branch still contains transitional one-file `:::lang` and body-image behavior. Issues #3, #4, #5, #6, and #8 define the target Article/LocaleVariant, compiler, integration, and bootstrap architecture. Do not extend transitional mechanisms into new long-term contracts without reconciling those issues first.
